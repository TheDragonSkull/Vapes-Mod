...
public class VapeCatalogScreen extends Screen {
    private static final ResourceLocation BACKGROUND = ResourceLocation.fromNamespaceAndPath(VapeMod.MOD_ID, "textures/gui/vape_catalog.png");
    ...
    protected void init() {
        ...
        for (int i = 0; i < vapeList.size(); i++) {
            ...
            this.addRenderableWidget(new VapeTradeButton(this.width / 2 - 120, y, i, costA, costB, vape, (btn) -> {
